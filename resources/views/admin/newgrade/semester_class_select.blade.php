				...
				<div class="p-6 text-gray-900 dark:text-gray-100 ">
					<form action={{route("grades_input")}}
						...
						<div class="flex flex-col">
							...
							<input name="semester_year" id="semester_year" value={{$year}} x-model="year"
						...
						<div class="flex flex-col ">
							...
							<select class="dark:bg-gray-800 rounded-lg py-1  border-gray-200" name="semester_part" id="semester_part">
