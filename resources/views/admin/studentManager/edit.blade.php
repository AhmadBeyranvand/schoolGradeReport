                ...
                <form method="post" class="max-w-xl">
                    ...
                    <div class="my-8">
                        ...
                        <x-text-input id="father_name" name="father_name" type="text" class="mt-1 block w-full"
                            :value="old('father_name', $user->father_name)" required autofocus autocomplete="last_name" />
                        <x-input-error class="mt-2" :messages="$errors->get('father_name')" />
                    </div>
                    <div class="my-8">
                        <x-input-label for="national_code" :value="__('National code')" />
                        <x-text-input id="national_code" name="national_code" type="text" class="mt-1 block w-full" :value="old('national_code', $user->national_code)" required autofocus autocomplete="name" />
                        <x-input-error class="mt-2" :messages="$errors->get('national_code')" />
                    </div>
                    <div class="my-8">
                        <x-input-label for="email" :value="__('E-mail')" />
                        <x-text-input style="direction:ltr" id="email" name="email" type="text" class="mt-1 block w-full" :value="old('email', $user->email)" required autofocus autocomplete="name" />
