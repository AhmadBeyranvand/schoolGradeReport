											...
											<tr>
												...
												<td>
													<a href={{route("show_student_edit", ['id' => $st->id])}}
														class="bg-[#cbcdda] text-gray-800 hover:bg-zinc-500 hover:text-white rounded m-1 p-1 text-xs">ویرایش
														اطلاعات</a>
													<a href={{route("show_student_grades", ['id' => $st->id])}}
														class="bg-emerald-600 hover:bg-emerald-700 rounded m-1 p-1 text-xs text-white">مشاهده
														نمرات</a>
												</td>
											</tr>
										@endforeach
									...
									@foreach ($students as $st)
										<tr class="bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-600">
											...
											<td class="border-b border-gray-200 dark:border-gray-600" data-label="عملیات">
												<a href={{route("show_student_edit", ['id' => $st->id])}}
													class="bg-[#cbcdda] text-gray-800 hover:bg-zinc-500 hover:text-white rounded mx-1 p-1 text-xs">ویرایش
													اطلاعات</a>
												<a href={{route("show_student_grades", ['id' => $st->id])}}
