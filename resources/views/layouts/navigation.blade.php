    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('new_semester_grade')" :active="request()->routeIs('new_semester_grade')">
            ...
            <!-- Settings Dropdown -->
            <div class="hidden sm:flex sm:items-center sm:ms-6" x-cloak>
                <x-dropdown class="text-gray-500">
                    ...
                    <div x-show="open" x-transition class="absolute bg-white flex flex-col rounded-lg border border-gray-200" style="width:120px">
                        ...
                        <form method="POST" action="{{ route('logout') }}">
                            ...
                            <x-dropdown-link class="py-2 px-10" :href="route('logout')"
